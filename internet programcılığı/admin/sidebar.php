<style type="text/css">
  ...
  <aside style="background-color:black" class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Yunus Özsarı</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Yunus Özsarı</a>
        </div>
      </div>
    ...
    <i id="beyazyazi" class="fas fa-address-card"></i>
              <p class="beyazyazi">
                Hakkımızda
              </p>
            </a>
         ...
         <i id="beyazyazi" class="fas fa-users-cog"></i>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <i id="beyazyazi" class="fas fa-user-cog"></i>
...
<i id="beyazyazi" class="fas fa-user-friends"></i>
              <p class="beyazyazi">
                Ekibimiz
              </p>
            </a>
        ...
        <i id="beyazyazi" class="fas fa-ellipsis-v"></i>
              <p class="beyazyazi">
                Kategoriler
              </p>
            </a>
       ...
       <li class="nav-item">
            ...
            <i id="beyazyazi" class="fas fa-comments"></i>
              <p class="beyazyazi">
                Yorumlar
              </p>
            </a>
